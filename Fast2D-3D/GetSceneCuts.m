function Cuts = GetSceneCuts(rootin,FR,resize_factor)
...
parfor fr = 1:FR(end)-1,
        
    I1 = double(imresize(imread([rootin num2str(fr) '.png']),resize_factor));
    I2 = double(imresize(imread([rootin num2str(fr+1) '.png']),resize_factor));
