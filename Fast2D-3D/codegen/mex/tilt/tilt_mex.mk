START_DIR = /Users/kiana/Desktop/2D_3D/Fast2D-3D

MATLAB_ROOT = /Applications/MATLAB_R2014a.app
MAKEFILE = tilt_mex.mk

include tilt_mex.mki
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/tilt"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/tilt/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/tilt/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/tilt/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/tilt/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
