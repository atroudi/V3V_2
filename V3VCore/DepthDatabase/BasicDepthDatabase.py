...
from DepthDatabase.Data import ImageFeaturesList, ImageData
...
class BasicDepthDatabase:
    ...
    def addImageData(self, imagePath, depthMapPath, startI, endI):
        """ 
            ...
            The image and depth map files should be numbere from startIndex to endIndex \
        ...
        if os.path.isfile(imagePath) and os.path.isfile(depthMapPath):
            ...
            for i in xrange(startI, endI+1):
                ...
                imageFilePath = os.path.join(imagePath, str(i)+".png")
                depthMapFilePath = os.path.join(depthMapPath, str(i)+".png")
